        ...
        {step === 2 && selectedAssetType && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
              ...
              {/* Real Estate: Dropdown selection */}
              {selectedAssetType === 'real_estate' && (
                <div>
                  ...
                  >
                    ...
                    {AVAILABLE_REAL_ESTATE.map((property) => (
                      <option key={property.label} value={property.label}>
                        {property.label}
                      </option>
                    ))}
                  </select>
              ...
              {selectedAssetType !== 'stock' && selectedAssetType !== 'real_estate' && (
                <div>
