        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              <p className="text-xs text-gray-500">{getAssetTypeLabel()}</p>
            </div>
            {isSelected && (
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              ...
              <span className="ml-1 font-medium text-gray-800">${asset.costBasis.toLocaleString()}</span>
            </div>
            {asset.monthlyIncome && asset.monthlyIncome > 0 && (
              <div className="col-span-2">
                <span className="text-gray-500">Monthly Income:</span>
                <span className="ml-1 font-medium text-green-600">${asset.monthlyIncome.toLocaleString()}/mo</span>
              </div>
            )}
          </div>
        </div>
